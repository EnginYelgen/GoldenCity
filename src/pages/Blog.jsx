  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 py-16 transition-colors duration-300">
      <div className="container">
        ...
        >
          <SectionHeader
            title="Real Estate & Crypto Insights"
            subtitle="Stay updated with the latest trends in real estate investment, cryptocurrency, and blockchain technology."
          />
        </motion.div>
          ...
          <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-md p-6 transition-colors duration-300">
            <div className="flex flex-col md:flex-row gap-4 md:gap-6">
              <div className="flex-1 md:flex-[2]">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="input pl-10 text-base md:text-lg py-3 md:py-3.5"
                    value={searchTerm}
              ...
              <div className="w-full md:flex-[1]">
                <select
                  className="input text-base md:text-lg py-3 md:py-3.5"
            ...
            >
              <Link to={`/blog/${post.slug}`}>
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-white dark:bg-secondary-900 px-3 py-1 rounded-full text-sm font-medium text-primary-600 dark:text-primary-300">
                    {categories.find(c => c.id === post.category)?.name}
                  </div>
                </div>
                <div className="p-6">
                  <h2 className="text-xl font-semibold mb-3 text-secondary-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-300 transition-colors">
                    {post.title}
                  </h2>
